...
class CouponUsageReportServiceTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        Schema::create('stj_pedidos_pago', function (Blueprint $t) { $t->id('ppa_id'); $t->unsignedBigInteger('ppa_pedido'); $t->string('ppa_estado'); $t->string('ppa_ref'); $t->decimal('ppa_monto_senv'); });
        ...
        DB::table('stj_pedidos_pago')->insert([
            ['ppa_id' => 20, 'ppa_pedido' => 10, 'ppa_estado' => 'APROBADA', 'ppa_ref' => 'STJ-ANA', 'ppa_monto_senv' => 90],
            ['ppa_id' => 21, 'ppa_pedido' => 11, 'ppa_estado' => 'APROBADA', 'ppa_ref' => 'STJ-LUIS', 'ppa_monto_senv' => 45],
        ]);
    ...
    public function test_it_filters_used_coupons_by_customer_email_and_returns_totals(): void
    {
        ...
        $this->assertSame(90.0, $result['rows'][0]['orderAmount']);
