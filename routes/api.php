...
use App\Http\Controllers\Api\StorefrontDenimController;
...
use App\Http\Controllers\Api\StorefrontNavigationController;
...
Route::get('/storefront/orders/{country}/pending-payment', [PowerTranzController::class, 'pending'])->where('country', '[A-Za-z]{2}');
